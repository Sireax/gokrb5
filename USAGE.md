...
```go
import "gitlab.akb-it.ru/cloud_sber/gokrb5/config"
...
```go
import 	"gitlab.akb-it.ru/cloud_sber/gokrb5/keytab"
...
```go
import 	"gitlab.akb-it.ru/cloud_sber/gokrb5/client"
...
```go
import 	"gitlab.akb-it.ru/cloud_sber/gokrb5/service"
